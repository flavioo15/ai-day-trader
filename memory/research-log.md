...
## 2026-06-21 — Initial Market Scan & First Trades

**Market Context:**
- Last trading day was June 18 (Thu). June 19 = Juneteenth holiday. June 20-21 = weekend.
- Next trading day: Monday June 22.
- Tech/AI stocks showed clear sector leadership on June 18.

**Price Data Reviewed (June 18 close vs prev day):**

| Stock | Close | 1-Day Chg | Signal |
|-------|-------|-----------|--------|
| AVGO | $411.07 | +4.62% | Strong buy |
| NVDA | $210.38 | +2.78% | Strong buy |
| META | $577.29 | +1.78% | Buy |
| GOOGL | $367.93 | +1.12% | Watch |
| MSFT | $379.08 | +0.01% | Neutral |
| GE | $357.67 | +0.18% | Neutral |
| V | $327.25 | -0.94% | Avoid |
| LLY | $1098.76 | -1.20% | Avoid |
| XOM | $137.81 | -2.12% | Avoid |
| JPM | $325.23 | -2.50% | Avoid |

**Key Findings:**
- AI/semiconductor sector is leading — AVGO (+4.62%), NVDA (+2.78%), META (+1.78%) show strongest momentum
- Financials (JPM -2.50%) and Energy (XOM -2.12%) showing weakness
- Healthcare (LLY -1.20%) pulling back
- Clear sector rotation into tech/AI names

**Action Items:**
- [x] Place buy orders for AVGO (12), NVDA (23), META (8) — DONE
- [ ] Place 10% trailing stops on all 3 positions after fills on Monday
- [ ] Research GOOGL as potential 4th position next week if tech momentum continues
- [ ] Monitor sector rotation — if financials/energy stabilize, consider diversifying

**Watchlist for Next Week:**
- GOOGL ($367.93) — solid fundamentals, moderate momentum, cloud margin expansion story
- MSFT ($379.08) — Azure/Copilot AI monetization, but flat price action needs catalyst
- AMD — check price action, AI accelerator competitor play
